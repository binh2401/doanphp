              ...
              <ul class="list-group mb-3">
                  <?php if (!empty($_SESSION['cart'])): ?>
                      ...
                      <li class="list-group-item d-flex justify-content-between">
                          <span>Total (USD)</span>
                          <strong>$<?= array_sum(array_map(function ($item) {
                                        return $item['price'] * $item['quantity'];
                                    }, $_SESSION['cart'])) ?></strong>
                      </li>
                  <?php else: ?>
                      <li class="list-group-item d-flex justify-content-between lh-sm">
                          <div>
              ...
              <div class="col-sm-6 offset-sm-2 offset-md-0 col-lg-4">
                  <div class="search-bar row bg-light p-2 rounded-4">
                      ...
                      <div class="col-11 col-md-7">
                          <form id="search-form" class="text-center" action="search.php" method="get">
                              <input type="text" name="query" class="form-control border-0 bg-transparent" placeholder="Search for more than 20,000 products">
                          </form>
                      </div>
                      <div class="col-1">
                  ...
                  <ul class="d-flex justify-content-end list-unstyled m-0">
                      <li class="nav-item dropdown">
                          <?php if (isset($_SESSION['user'])): ?>
                              <a href="#" class="nav-link dropdown-toggle p-2 mx-1" id="userDropdown" role="button" data-bs-toggle="dropdown" aria-expanded="false">
